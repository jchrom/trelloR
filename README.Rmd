...
The CRAN version has been long outdated and should not be preferred. The CRAN
package will be updated when version 0.7 is released. In the meantime, please
use the development version above.

Built using [httr](https://cran.r-project.org/package=httr) and [jsonlite](https://cran.r-project.org/package=jsonlite).
