...
Private and team boards can be accessed using a secure token. Check the vignettes to [get started](https://jchrom.github.io/trelloR/docs/articles/get-public-data.html).
