...
Most of the functions in this package are wrappers for `get_model()`. You can call it directly if you lack a particular data-fetching option, or you can define a new function by wrapping `get_model()` and providing some default values. 
