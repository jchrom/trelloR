...
* `token` (see the **Getting private data**)
...
* `fix` does not do much now but in the future it's meant to drop some infrequently used columns from the response and impose a consistent naming scheme that would make table joins easier
